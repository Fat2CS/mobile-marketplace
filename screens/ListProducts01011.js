...
const ListProducts01011 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.listProducts010102}>
      ...
      <View style={[styles.listProducts, styles.headerPosition]}>
        <View style={[styles.cardProduct, styles.cardLayout3]}>
          <View style={[styles.frameParent, styles.cardLayout3]}>
            ...
            <View style={[styles.frameGroup, styles.frameSpaceBlock]}>
              ...
              >
                ...
                <View style={styles.btnCounter}>
                  ...
                  />
                  <View style={[styles.btnMinus, styles.btnPosition2]}>
                    <Image
                      style={[styles.btnMinusChild, styles.btnChildLayout]}
                      contentFit="cover"
                  ...
                  <Image
                    style={[styles.btnCounterItem, styles.btnChildLayout]}
                    contentFit="cover"
                  ...
                  <View style={[styles.counter, styles.counterChildPosition]}>
                    <View style={styles.parent}>
                      ...
                      <Text style={[styles.text3, styles.textFlexBox]}>2</Text>
                      <Text style={[styles.text3, styles.textFlexBox]}>3</Text>
                      <Text style={[styles.text3, styles.textFlexBox]}>4</Text>
          ...
          <View style={[styles.frameParent, styles.cardLayout3]}>
            ...
            <View style={[styles.frameGroup, styles.frameSpaceBlock]}>
              ...
              >
                ...
                <View style={styles.btnCounter}>
                  <View
                    style={[styles.rectangleView, styles.counterChildPosition]}
                  />
                  <View style={[styles.btnMinus, styles.btnPosition2]}>
                    <Image
                      style={[styles.btnMinusChild, styles.btnChildLayout]}
        ...
        <View style={[styles.cardProduct4, styles.cardLayout1]}>
          <View style={[styles.frameParent, styles.cardLayout3]}>
            ...
            <View style={[styles.frameGroup, styles.frameSpaceBlock]}>
              <View style={styles.cardTitleParent}>
                <Text style={[styles.cardTitle, styles.cardTypo]}>Piments</Text>
                <Text style={styles.cardSubtitle}>Polynésie Française</Text>
              </View>
              <View
                style={[styles.frameContainer, styles.titleCategoryFlexBox]}
        ...
        <View style={[styles.cardProduct5, styles.cardLayout]}>
          <View style={[styles.frameParent, styles.cardLayout3]}>
            ...
            <View style={[styles.frameGroup, styles.frameSpaceBlock]}>
              <View style={styles.cardTitleParent}>
                <Text style={[styles.cardTitle, styles.cardTypo]}>Avocat</Text>
                <Text style={styles.cardSubtitle}>Polynésie Française</Text>
              </View>
              <View
                style={[styles.frameContainer, styles.titleCategoryFlexBox]}
        ...
        <View style={[styles.cardProduct6, styles.cardLayout3]}>
          <View style={[styles.frameParent, styles.cardLayout3]}>
            ...
            <View style={[styles.frameGroup, styles.frameSpaceBlock]}>
              <View style={styles.cardTitleParent}>
                <Text style={[styles.cardTitle, styles.cardTypo]}>Oeufs</Text>
                <Text style={styles.cardSubtitle}>Polynésie Française</Text>
              </View>
              <View
                style={[styles.frameContainer, styles.titleCategoryFlexBox]}
      ...
      <View style={[styles.header, styles.headerPosition]}>
        <Pressable
          ...
          onPress={() => navigation.navigate("ListCategoriesProducts011")}
        >
          <Image
          ...
          />
          <Text
            style={[styles.fruitsLgumes, styles.cardTypo]}
          >{`Fruits & Légumes`}</Text>
        </Pressable>
      ...
      <View style={styles.tabBar}>
        <View style={[styles.divtabIcons, styles.divtabIconsPosition]}>
          <View style={[styles.divicoHome, styles.divicoIconLayout]}>
            <Image
              style={[styles.iconsBtn11, styles.btnPosition]}
              contentFit="cover"
        ...
        <View style={styles.btnCta}>
          <Image
            style={[styles.btnCtaChild, styles.btnChildLayout]}
            contentFit="cover"
          ...
          />
          <View style={styles.iconsBtn12}>
            <Image
              style={[styles.btnCtaChild, styles.btnChildLayout]}
              contentFit="cover"
              source={require("../assets/ellipse-201.png")}
            />
            <Text style={[styles.text70, styles.textClr]}>1</Text>
          </View>
        </View>
      </View>
      <View style={[styles.statusBar, styles.textPosition]}>
        <View style={styles.battery}>
          ...
          <Image
            style={[styles.capIcon, styles.btnChildLayout]}
            contentFit="cover"
...
export default ListProducts01011;

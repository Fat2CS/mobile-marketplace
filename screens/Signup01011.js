      ...
      <View style={[styles.body, styles.bodyPosition]}>
        ...
        <View style={styles.buttonsSocialMedia}>
          <Image
            ...
            contentFit="cover"
            source={require("../assets/buttonsconnect2.png")}
          />
          <Image
        ...
        <View style={styles.formsignup}>
          ...
          <Text
            style={[styles.applicationLocaleDestine, styles.h2Clr]}
          >{`- Application locale destinée à Tahiti - `}</Text>
          <Pressable
